export function getWritingStyle(lifeStyleSegment: string){
    ...
    if(lifeStyleSegment === 'outdoors') {
        style.push('product is geared towards a customer that enjoys the outdoors, and may enjoy hobbies such as fishing, camping, hunting, kayaking, or other outdoor activities.')
    }
